...
class Test {
    Test(unsigned long long key_number): dijkstraCI(DIJKSTRA_MODE), floyd_warshallCI(FLOYD_WARSHALL_MODE)
    {
        k = m = n = key_number;
        ...
        uniform_int_distribution<int> dist(1, 1000); // guaranteed unbiased
